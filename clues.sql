...
SELECT code, name, region, population FROM countries WHERE region = 'Southern Europe' ORDER BY population ASC LIMIT 20;
...
SELECT * FROM cities WHERE name='Serravalle';
